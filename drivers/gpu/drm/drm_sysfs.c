...
/*Bug 434542 add brightness contrl node for f9s ---wt_zhangxiaolong begin*/
...
static DEVICE_ATTR_RW(disp_param); //Bug 434542 add brightness contrl node for f9s ---wt_zhangxiaolong
static DEVICE_ATTR_RW(acl); //bug430786 sijun.wt,Modify,20190419,add acl function
...
static struct attribute *connector_dev_attrs[] = {
	...
	&dev_attr_dpms.attr,
	&dev_attr_modes.attr,
	&dev_attr_disp_param.attr,  //Bug 434542 add brightness contrl node for f9s ---wt_zhangxiaolong
	&dev_attr_acl.attr,    //bug430786 sijun.wt,Modify,20190419,add acl function
	&dev_attr_white_read.attr,  //bug430786 sijun.wt,Modify,20190423,add white point function
	NULL
};
