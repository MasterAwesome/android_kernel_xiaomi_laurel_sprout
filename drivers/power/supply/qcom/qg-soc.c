...
int qg_adjust_sys_soc(struct qpnp_qg *chip)
{
	...
	int ibat = 0;//Extb 62849, zhaolinquan.wt, MODIFY, 20190529, for terminal charging current issues
	...
	if (chip->sys_soc == QG_MAX_SOC) {
		...
		//+Extb 62849, zhaolinquan.wt, MODIFY, 20190529, for terminal charging current issues
		{
